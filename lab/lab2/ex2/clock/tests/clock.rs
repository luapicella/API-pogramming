...
#[test]
fn test_add_one_min() {
    let clock = Clock::new(2, 20) + Clock::new(2, 20);
    assert_eq!(clock.to_string(), "04:40");
}
...
fn test_add_more_than_one_hour2() {
...
fn test_add_more_than_two_hours_with_carry2() {
...
fn test_add_more_than_one_day2() {
...
fn test_add_more_than_two_days2() {
    let clock = Clock::new(1, 1) + 3500;
    assert_eq!(clock.to_string(), "11:21");
}
...
fn test_subtract_to_previous_hour2() {
...
fn test_subtract_more_than_an_hour2() {
...
fn test_subtract_across_midnight2() {
...
fn test_subtract_more_than_two_hours2() {
...
fn test_subtract_more_than_two_hours_with_borrow2() {
...
fn test_subtract_more_than_one_day2() {
    let clock = Clock::new(5, 32) - 1500;
    assert_eq!(clock.to_string(), "04:32");
}
...
fn test_subtract_more_than_two_days2() {
